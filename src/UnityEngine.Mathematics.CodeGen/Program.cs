...
namespace UnityEngine.Mathematics.CodeGen
{
    class MainClass
    {
        public static void Main (string[] args)
        {
            ...
            // go from `src/UnityEngine.Mathematics.CodeGen/bin/Debug`
            ...
            directory = new DirectoryInfo(Path.Combine(parent.FullName, "UnityEngine.Mathematics"));
            if (!directory.Exists)
            {
