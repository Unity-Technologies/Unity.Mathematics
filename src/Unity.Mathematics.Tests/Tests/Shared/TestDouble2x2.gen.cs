...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestDouble2x2
    {
        ...
        [TestCompiler]
        public void double2x2_operator_less_wide_wide()
        {
            ...
            double2x2 b1 = double2x2(100.21050290959443, 182.56098636545289, 3.116978885194726, -259.43047893207074);
        ...
        [TestCompiler]
        public void double2x2_operator_less_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_less_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_greater_wide_wide()
        {
            ...
            double2x2 b2 = double2x2(340.94807140014507, 25.986035120666998, -114.2111352021858, 240.80346428640348);
            bool2x2 r2 = bool2x2(false, true, false, false);
            TestUtils.AreEqual(a2 > b2, r2);
        ...
        [TestCompiler]
        public void double2x2_operator_greater_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_greater_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_less_equal_wide_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_less_equal_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_less_equal_scalar_wide()
        {
            double a0 = (393.60626644343427);
            double2x2 b0 = double2x2(-75.688363825757222, -44.2638714519627, 125.8649156679702, 191.96488174794467);
            bool2x2 r0 = bool2x2(false, false, false, false);
            TestUtils.AreEqual(a0 <= b0, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_greater_equal_wide_wide()
        {
            ...
            double2x2 b1 = double2x2(-6.859075311040101, 319.72570362674332, 254.079170106947, 396.5724000393285);
            bool2x2 r1 = bool2x2(false, false, false, false);
            TestUtils.AreEqual(a1 >= b1, r1);
        ...
        [TestCompiler]
        public void double2x2_operator_greater_equal_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_greater_equal_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_add_wide_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_add_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_add_scalar_wide()
        {
            ...
            double2x2 r0 = double2x2(171.00757368421535, -486.57132076032991, -446.56510946087781, -703.80493244519687);
            TestUtils.AreEqual(a0 + b0, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_sub_wide_wide()
        {
            ...
            double2x2 r3 = double2x2(399.90425939108445, 107.4317131542748, -384.02281111479869, 234.06105863026392);
            TestUtils.AreEqual(a3 - b3, r3);
        }

        [TestCompiler]
        public void double2x2_operator_sub_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_sub_scalar_wide()
        {
            ...
            double2x2 r2 = double2x2(923.57967228981647, 219.42955647196141, 450.5426633071819, 340.36686340922813);
            TestUtils.AreEqual(a2 - b2, r2);
        ...
        [TestCompiler]
        public void double2x2_operator_mul_wide_wide()
        {
            ...
            double2x2 r0 = double2x2(114098.04331156027, -106192.64949051509, -57336.638772880389, -76012.328533757158);
            TestUtils.AreEqual(a0 * b0, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_mul_wide_scalar()
        {
            ...
            double2x2 a2 = double2x2(53.796284939067618, 135.35469991311186, -207.35010275959508, -383.93960946795517);
        ...
        [TestCompiler]
        public void double2x2_operator_mul_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_div_wide_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_div_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_div_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_mod_wide_wide()
        {
            ...
            double2x2 b3 = double2x2(-358.74544947163452, -198.15921005893461, 208.73709378425826, -12.119406944196385);
            double2x2 r3 = double2x2(-124.03371745163281, 61.114747552720246, -65.621356517831487, -6.7173275978851734);
            TestUtils.AreEqual(a3 % b3, r3);
        }

        [TestCompiler]
        public void double2x2_operator_mod_wide_scalar()
        {
            double2x2 a0 = double2x2(-244.49962889612635, -211.81931958525411, -145.92677576184588, -304.91822090042672);
        ...
        [TestCompiler]
        public void double2x2_operator_mod_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_plus()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_neg()
        {
            double2x2 a0 = double2x2(148.46174890755754, -467.12267873581624, 132.04719954917539, 183.52262290917463);
            double2x2 r0 = double2x2(-148.46174890755754, 467.12267873581624, -132.04719954917539, -183.52262290917463);
            TestUtils.AreEqual(-a0, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_prefix_inc()
        {
        ...
        [TestCompiler]
        public void double2x2_operator_postfix_inc()
        {
            double2x2 a0 = double2x2(-396.6697396695007, 511.20749378167443, 249.11127030528678, -128.81731301584154);
            double2x2 r0 = double2x2(-396.6697396695007, 511.20749378167443, 249.11127030528678, -128.81731301584154);
            TestUtils.AreEqual(a0++, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_prefix_dec()
        {
            double2x2 a0 = double2x2(123.12869626056806, 256.8437465433235, 156.33078844674435, 461.73742530389563);
            double2x2 r0 = double2x2(122.12869626056806, 255.84374654332351, 155.33078844674435, 460.73742530389563);
            TestUtils.AreEqual(--a0, r0);
        ...
        [TestCompiler]
        public void double2x2_operator_postfix_dec()
        {
