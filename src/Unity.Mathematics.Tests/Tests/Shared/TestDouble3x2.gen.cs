...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestDouble3x2
    {
        ...
        [TestCompiler]
        public void double3x2_operator_less_wide_wide()
        {
            ...
            double3x2 b0 = double3x2(-465.34502313348696, -256.15239751346053, -314.814018634527, 364.56673662949663, 100.21050290959443, 182.56098636545289);
        ...
        [TestCompiler]
        public void double3x2_operator_less_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_less_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_greater_wide_wide()
        {
            ...
            double3x2 b1 = double3x2(362.79748861994483, 324.95341816775192, 340.94807140014507, 25.986035120666998, -114.2111352021858, 240.80346428640348);
        ...
        [TestCompiler]
        public void double3x2_operator_greater_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_greater_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_less_equal_wide_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_less_equal_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_less_equal_scalar_wide()
        {
            double a0 = (393.60626644343427);
            double3x2 b0 = double3x2(-75.688363825757222, -44.2638714519627, 125.8649156679702, 191.96488174794467, 13.543054825413492, -197.0519259893577);
            bool3x2 r0 = bool3x2(false, false, false, false, false, false);
            TestUtils.AreEqual(a0 <= b0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_greater_equal_wide_wide()
        {
            ...
            double3x2 b0 = double3x2(-81.346509732933043, 297.66615047010885, 171.06540616371922, -431.03805538222105, -6.859075311040101, 319.72570362674332);
        ...
        [TestCompiler]
        public void double3x2_operator_greater_equal_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_greater_equal_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_add_wide_wide()
        {
            ...
            double3x2 a3 = double3x2(286.35534037573041, -333.41949311523672, -118.93216973120912, 68.607509406566351, 23.190902005504313, -205.57787547147734);
        ...
        [TestCompiler]
        public void double3x2_operator_add_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_add_scalar_wide()
        {
            ...
            double3x2 r0 = double3x2(171.00757368421535, -486.57132076032991, -446.56510946087781, -703.80493244519687, -141.26509959123337, -367.46309011404549);
            TestUtils.AreEqual(a0 + b0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_sub_wide_wide()
        {
            ...
            double3x2 r2 = double3x2(399.90425939108445, 107.4317131542748, -384.02281111479869, 234.06105863026392, 746.48410116624268, 450.78426095972969);
            TestUtils.AreEqual(a2 - b2, r2);
        ...
        [TestCompiler]
        public void double3x2_operator_sub_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_sub_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_mul_wide_wide()
        {
            ...
            double3x2 r0 = double3x2(114098.04331156027, -106192.64949051509, -57336.638772880389, -76012.328533757158, -49185.69370281692, 178783.69114527057);
            TestUtils.AreEqual(a0 * b0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_mul_wide_scalar()
        {
            ...
            double3x2 a1 = double3x2(-455.50827500573746, -338.29248658674419, 53.796284939067618, 243.75734459783757, 135.35469991311186, -207.35010275959508);
            double b1 = (-389.24327367788334);
            double3x2 r1 = double3x2(177303.53215059883, 131678.07493965575, -20939.842061390889, -94880.9067942902, -52685.906501867168, 80709.6327955903);
            TestUtils.AreEqual(a1 * b1, r1);
        ...
        [TestCompiler]
        public void double3x2_operator_mul_scalar_wide()
        {
            ...
            double3x2 r2 = double3x2(212962.49375283587, 159672.45359917657, -64519.758029811986, -195440.00453392946, -1574.7818802984878, -210096.52624154196);
            TestUtils.AreEqual(a2 * b2, r2);
        ...
        [TestCompiler]
        public void double3x2_operator_div_wide_wide()
        {
            ...
            double3x2 r3 = double3x2(0.32959249525403717, -0.15551745124635386, -9.855767936625206, 0.79597808465769837, 0.95624080018671487, -2.420892143165184);
            TestUtils.AreEqual(a3 / b3, r3);
        }

        [TestCompiler]
        public void double3x2_operator_div_wide_scalar()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_div_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_mod_wide_wide()
        {
            ...
            double3x2 b2 = double3x2(-358.74544947163452, -198.15921005893461, 208.73709378425826, -12.119406944196385, 25.27141596063575, -194.12068495253135);
            ...
            double3x2 a3 = double3x2(211.42317328761476, -51.272212767634642, -230.63392483006879, 99.989400671790122, 399.18986649028488, 24.903281461868119);
            ...
            double3x2 r3 = double3x2(211.42317328761476, -51.272212767634642, -13.653319365183506, 99.989400671790122, 399.18986649028488, 0.46435594580361794);
            TestUtils.AreEqual(a3 % b3, r3);
        }

        [TestCompiler]
        public void double3x2_operator_mod_wide_scalar()
        {
            double3x2 a0 = double3x2(-244.49962889612635, -211.81931958525411, -145.92677576184588, -304.91822090042672, 155.47946436492703, -133.90778428591221);
        ...
        [TestCompiler]
        public void double3x2_operator_mod_scalar_wide()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_plus()
        {
        ...
        [TestCompiler]
        public void double3x2_operator_neg()
        {
            double3x2 a0 = double3x2(148.46174890755754, -467.12267873581624, 132.04719954917539, 183.52262290917463, 473.7010145009034, -407.99109024926605);
            double3x2 r0 = double3x2(-148.46174890755754, 467.12267873581624, -132.04719954917539, -183.52262290917463, -473.7010145009034, 407.99109024926605);
            TestUtils.AreEqual(-a0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_prefix_inc()
        {
            double3x2 a0 = double3x2(-139.84208137348389, -56.743654039103376, -381.955324589254, 509.79634380237962, -222.89634452708827, 210.31986556310199);
            double3x2 r0 = double3x2(-138.84208137348389, -55.743654039103376, -380.955324589254, 510.79634380237962, -221.89634452708827, 211.31986556310199);
            TestUtils.AreEqual(++a0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_postfix_inc()
        {
            double3x2 a0 = double3x2(-396.6697396695007, 511.20749378167443, 249.11127030528678, -128.81731301584154, -259.49027669592306, 278.00817764830219);
            double3x2 r0 = double3x2(-396.6697396695007, 511.20749378167443, 249.11127030528678, -128.81731301584154, -259.49027669592306, 278.00817764830219);
            TestUtils.AreEqual(a0++, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_prefix_dec()
        {
            ...
            double3x2 r0 = double3x2(122.12869626056806, 255.84374654332351, 155.33078844674435, 460.73742530389563, 324.86799755965728, 391.01561731473339);
            TestUtils.AreEqual(--a0, r0);
        ...
        [TestCompiler]
        public void double3x2_operator_postfix_dec()
        {
