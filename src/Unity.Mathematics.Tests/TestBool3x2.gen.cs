...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestBool3x2
    {
        ...
        [Test]
        public void bool3x2_operator_bitwise_not()
        {
            bool3x2 a0 = bool3x2(false, false, false, false, true, false);
            bool3x2 r0 = bool3x2(true, true, true, true, false, true);
            TestUtils.AreEqual(!a0, r0);

            bool3x2 a1 = bool3x2(true, false, false, false, false, false);
            bool3x2 r1 = bool3x2(false, true, true, true, true, true);
            TestUtils.AreEqual(!a1, r1);

            bool3x2 a2 = bool3x2(false, false, false, false, false, true);
            bool3x2 r2 = bool3x2(true, true, true, true, true, false);
            TestUtils.AreEqual(!a2, r2);

            bool3x2 a3 = bool3x2(true, false, true, false, false, true);
