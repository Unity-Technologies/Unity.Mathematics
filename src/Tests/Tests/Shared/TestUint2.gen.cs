...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestUint2
    {
        ...
        [TestCompiler]
        public static void uint2_swizzle_getters()
        {
            var v1 = new uint2(0, 1);
        ...
        [TestCompiler]
        public static void uint2_swizzle_setters()
        {
            var v1 = new uint2(0, 1);
            ...
            set = v1;
            set.xy = v1.xy;
            TestUtils.AreEqual(uint2(0, 1), set);
            set = v1;
            set.yx = v1.xy;
            TestUtils.AreEqual(uint2(1, 0), set);
        }

        [TestCompiler]
        public static void uint2_colorswizzle_getters()
        {
            var v1 = new uint2(0, 1);
        ...
        [TestCompiler]
        public static void uint2_colorswizzle_setters()
        {
            var v1 = new uint2(0, 1);
