...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestFloat2
    {
        ...
        [TestCompiler]
        public static void float2_swizzle_getters()
        {
        ...
        [TestCompiler]
        public static void float2_swizzle_setters()
        {
            var v1 = new float2(0, 1);
        ...
        [TestCompiler]
        public static void float2_colorswizzle_getters()
        {
            var v1 = new float2(0, 1);
        ...
        [TestCompiler]
        public static void float2_colorswizzle_setters()
        {
            var v1 = new float2(0, 1);
