...
namespace Unity.Mathematics.Tests
{
    ...
    public class TestNormalizedPlane
    {
        ...
        {
            var p = new NormalizedPlane { NormalAndDistance = new float4(1.0f, 2.0f, 3.0f, 4.0f) };
        ...
        public static void ConstructWithCoefficients_NonUnitLengthNormal()
        {
            ...
            var p = new NormalizedPlane(abcd.x, abcd.y, abcd.z, abcd.w);
        ...
        public static void SignedDistanceToPoint()
        {
            ...
            var p = new NormalizedPlane(vInPlane1, vInPlane2, pointInPlane);
