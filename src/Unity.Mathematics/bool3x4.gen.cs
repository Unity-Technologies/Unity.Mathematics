...
namespace Unity.Mathematics
{
    ...
    public partial struct bool3x4 : System.IEquatable<bool3x4>
    {
        ...
        /// <summary>Constructs a bool3x4 matrix constructed from a single bool value by assigning it to every entry.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a single bool value to a bool3x4 matrix by assigning it to every entry.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    {
        /// <summary>Returns a bool3x4 matrix constructed from 4 bool3 vectors.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Returns a bool3x4 matrix constructed from a single bool value by assigning it to every entry.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            return csum(select(uint3(0xDCDD5341u, 0x94DDD769u, 0xA1E92D39u), uint3(0x4583C801u, 0x9536A0F5u, 0xAF816615u), v.c0) + 
                        select(uint3(0x9AF8D62Du, 0xE3600729u, 0x5F17300Du), uint3(0x670D6809u, 0x7AF32C49u, 0xAE131389u), v.c1) + 
                        select(uint3(0x5D1B165Bu, 0x87096CD7u, 0x4C7F6DD1u), uint3(0x4822A3E9u, 0xAAC3C25Du, 0xD21D0945u), v.c2) + 
                        select(uint3(0x88FCAB2Du, 0x614DA60Du, 0x5BA2C50Bu), uint3(0x8C455ACBu, 0xCD266C89u, 0xF1852A33u), v.c3));
        }
        ...
        {
            return (select(uint3(0x77E35E77u, 0x863E3729u, 0xE191B035u), uint3(0x68586FAFu, 0xD4DFF6D3u, 0xCB634F4Du), v.c0) + 
                    select(uint3(0x9B13B92Du, 0x4ABF0813u, 0x86068063u), uint3(0xD75513F9u, 0x5AB3E8CDu, 0x676E8407u), v.c1) + 
                    select(uint3(0xB36DE767u, 0x6FCA387Du, 0xAF0F3103u), uint3(0xE4A056C7u, 0x841D8225u, 0xC9393C7Du), v.c2) + 
                    select(uint3(0xD42EAFA3u, 0xD9AFD06Du, 0x97A65421u), uint3(0x7809205Fu, 0x9C9F0823u, 0x5A9CA13Bu), v.c3));
        }
