...
namespace Unity.Mathematics
{
    ...
    public partial struct double2x3 : System.IEquatable<double2x3>, IFormattable
    {
        ...
        public double2x3(in double2 c0, in double2 c1, in double2 c2)
        { 
            this.c0 = c0;
            this.c1 = c1;
            this.c2 = c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x3(in float2x3 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
            this.c2 = v.c2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in double v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double2x3(in bool v) { return new double2x3(v); }

        /// <summary>Explicitly converts a bool2x3 matrix to a double2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double2x3(in bool2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in int v) { return new double2x3(v); }

        /// <summary>Implicitly converts a int2x3 matrix to a double2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in int2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in uint v) { return new double2x3(v); }

        /// <summary>Implicitly converts a uint2x3 matrix to a double2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in uint2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in float v) { return new double2x3(v); }

        /// <summary>Implicitly converts a float2x3 matrix to a double2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(in float2x3 v) { return new double2x3(v); }


        /// <summary>Returns the result of a componentwise multiplication operation on two double2x3 matrices.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 operator * (in double2x3 lhs, in double2x3 rhs) { return new double2x3 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1, lhs.c2 * rhs.c2); }

        /// <summary>Returns the result of a componentwise multiplication operation on a double2x3 matrix and a double value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 operator * (in double2x3 lhs, in double rhs) { return new double2x3 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a double value and a double2x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 operator * (in double lhs, in double2x3 rhs) { return new double2x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator < (in double2x3 lhs, in double2x3 rhs) { return new bool2x3 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2); }

        /// <summary>Returns the result of a componentwise less than operation on a double2x3 matrix and a double value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator < (in double2x3 lhs, in double rhs) { return new bool2x3 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a double value and a double2x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x3 operator < (in double lhs, in double2x3 rhs) { return new bool2x3 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2); }
    ...
    public static partial class math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in double2 c0, in double2 c1, in double2 c2) { return new double2x3(c0, c1, c2); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in double v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in bool v) { return new double2x3(v); }

        /// <summary>Return a double2x3 matrix constructed from a bool2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in bool2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in int v) { return new double2x3(v); }

        /// <summary>Return a double2x3 matrix constructed from a int2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in int2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in uint v) { return new double2x3(v); }

        /// <summary>Return a double2x3 matrix constructed from a uint2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in uint2x3 v) { return new double2x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in float v) { return new double2x3(v); }

        /// <summary>Return a double2x3 matrix constructed from a float2x3 matrix by componentwise conversion.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(in float2x3 v) { return new double2x3(v); }

        /// <summary>Return the double3x2 transpose of a double2x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3x2 transpose(in double2x3 v)
        {
            return double3x2(
                v.c0.x, v.c0.y,
                v.c1.x, v.c1.y,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(in double2x3 v)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 hashwide(in double2x3 v)
        {
