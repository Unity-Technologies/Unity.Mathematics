...
namespace Unity.Mathematics
{
    ...
    public partial struct double4x3 : System.IEquatable<double4x3>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x3(in double v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double4x3(in bool v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x3(in int v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x3(in uint v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x3(in float v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 operator * (in double4x3 lhs, in double rhs) { return new double4x3 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a double value and a double4x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 operator * (in double lhs, in double4x3 rhs) { return new double4x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x3 operator < (in double4x3 lhs, in double rhs) { return new bool4x3 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a double value and a double4x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool4x3 operator < (in double lhs, in double4x3 rhs) { return new bool4x3 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2); }
    ...
    public static partial class math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(in double v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(in bool v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(in int v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(in uint v) { return new double4x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(in float v) { return new double4x3(v); }
